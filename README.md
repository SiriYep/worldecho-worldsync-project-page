...
- **Method overview:** the original WorldSync method diagram (paper Figure 4) appears immediately after the abstract, replacing the four-part research summary. The uncropped figure uses the wide media layout, has zoom and original-PDF links, and is displayed once. The later training section links back to it and retains the three component explanations.
- **Abstract:** placed directly after paper Figure 1 and before the method diagram and interactive preview, it uses a centered Abstract heading and an 880px reading column, followed by paper links. It contains the complete public arXiv v1 abstract, with paragraph breaks added for reading, rather than the previous site-specific summary. The primary presentation references remain Hi-WM and WorldSimProbe.
