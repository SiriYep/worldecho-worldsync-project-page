...
- **Abstract:** the last content section uses a centered Abstract heading and an 880px reading column, followed by paper links. It contains the complete public arXiv v1 abstract, with paragraph breaks added for reading, rather than the previous site-specific summary. The primary presentation references remain Hi-WM and WorldSimProbe.
